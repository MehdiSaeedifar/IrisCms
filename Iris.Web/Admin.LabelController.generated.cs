...
namespace Iris.Web.Areas.Admin.Controllers
{
    public partial class LabelController
    {
        ...
        {
            public readonly string labelModel = ("labelModel").ToLowerInvariant();
        }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_LabelController : Iris.Web.Areas.Admin.Controllers.LabelController
    {
        ...
        [NonAction]
        partial void AddOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Iris.Model.AdminModel.AddLabelModel labelModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult Add(Iris.Model.AdminModel.AddLabelModel labelModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Add);
