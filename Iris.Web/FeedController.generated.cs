...
namespace Iris.Web.Controllers
{
    public partial class FeedController
    {
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string Comments = ("Comments").ToLowerInvariant();
        }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_FeedController : Iris.Web.Controllers.FeedController
    {
        public T4MVC_FeedController() : base(Dummy.Instance) { }

        [NonAction]
        partial void PostsOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult Posts()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Posts);
            PostsOverride(callInfo);
            return callInfo;
        }
