...
namespace Iris.Web.Areas.Admin.Controllers
{
    ...
    public partial class PostController : Controller
    {
        ...
        {
            ViewBag.PostId = id;
            return PartialView(MVC.Admin.Post.Views._ConfirmDelete);
        }
        ...
        public virtual ActionResult Delete(int id)
        {
            ...
            return PartialView(MVC.Admin.Shared.Views._Alert, new Alert { Message = "پست مورد نظر با موفقیت حذف شد" });
        }
