...
namespace Iris.Web.Helpers
{
    ...
    public class TreeView<T> : IHtmlString
    {
        ...
        public void Render()
        {
            TextWriter writer = _html.ViewContext.Writer;
        ...
        private void ValidateSettings()
        {
            if (_childrenProperty == null)
            {
                throw new InvalidOperationException(
                    "You must call the Children() method to tell the tree view how to find child items");
            }
        }
        ...
        public override string ToString()
        {
            ...
            List<T> listItems = _items.ToList();
        ...
        {
            IEnumerable<T> children = childrenProperty(parentItem);
        ...
        {
            TagBuilder li = GetLi(parentItem);
