...
namespace Iris.Web.Areas.Admin.Controllers
{
    ...
    public class CommentController : Controller
    {
        ...
        public virtual ActionResult Edit(int id)
        {
            ...
            return PartialView("_Edit", new EditCommentModel
            {
        ...
        {
            return ViewComponent("ApproveButtons", new {id, type});
        }
    ...
    public class ApproveButtonsViewComponent : ViewComponent
    {
        public IViewComponentResult Invoke(int id, string type)
        {
            ViewBag.Id = id;
            ViewBag.Status = (type == "approved") ? "approved" : "disapproved";
            return View("_ApproveStatusButton");
        }
    }
}